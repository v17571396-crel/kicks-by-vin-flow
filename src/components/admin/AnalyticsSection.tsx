  ...
  const revenueByDay = useMemo(() => {
    ...
    for (let i = days - 1; i >= 0; i--) {
      ...
      const dayOrders = orders.filter((o) => {
        ...
        return isAfter(created, day) && !isAfter(created, nextDay) && o.status !== 'cancelled';
      });
      result.push({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg p-5">
        <h3 className="font-display text-sm font-semibold text-foreground mb-4">Revenue Trend (14 Days)</h3>
